...
ActiveRecord::Schema.define(version: 2021_07_15_031218) do
  ...
  create_table "photolikes", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["comment_id"], name: "index_photolikes_on_comment_id"
    t.index ["user_id"], name: "index_photolikes_on_user_id"
  end
  ...
  add_foreign_key "photolikes", "comments"
  add_foreign_key "photolikes", "users"
